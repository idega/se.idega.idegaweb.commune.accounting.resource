...
public interface ResourceBusiness extends com.idega.business.IBOService
{
 ...
 public void createResourcePlacement(int p0,int p1,java.lang.String p2,java.lang.String p3,int p4)throws java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.resource.business.DateException,se.idega.idegaweb.commune.accounting.resource.business.ResourceException,se.idega.idegaweb.commune.accounting.resource.business.ClassMemberException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.accounting.resource.data.ResourceClassMember createResourcePlacement(int p0,int p1,java.lang.String p2,int p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public void createResourcePlacement(int p0,int p1,java.lang.String p2,java.lang.String p3,int p4,boolean p5)throws java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.resource.business.DateException,se.idega.idegaweb.commune.accounting.resource.business.ResourceException,se.idega.idegaweb.commune.accounting.resource.business.ClassMemberException, java.rmi.RemoteException;
